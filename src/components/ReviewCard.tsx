...
export function ReviewCard({ review, onHelpful }: { review: Review; onHelpful?: (id: string) => void }) {
  ...
  return (
    <View style={styles.card}>
      ...
      <Pressable onPress={handleHelpful} style={styles.helpfulBtn} accessibilityRole="button">
        <Ionicons name={marked ? 'thumbs-up' : 'thumbs-up-outline'} size={14} color={marked ? colors.primary : colors.textSecondary} />
...
const createStyles = (colors: AppColors) => StyleSheet.create({
  card: { paddingVertical: spacing.md, borderBottomWidth: 1, borderBottomColor: colors.divider, gap: spacing.xxs },
  ...
  reviewImage: { width: 56, height: 56, borderRadius: radius.sm, backgroundColor: colors.surfaceMuted },
  helpfulBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: spacing.xs, alignSelf: 'flex-start' },
