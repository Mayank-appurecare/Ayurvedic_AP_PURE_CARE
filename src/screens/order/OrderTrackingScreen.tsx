      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.summaryCard}>
            ...
            {!!order.deliveryEstimate && <Text style={styles.estimate}>{order.deliveryEstimate}</Text>}
...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  summaryCard: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: spacing.md, gap: spacing.xxs, ...shadow.sm },
  ...
  timelineCard: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: spacing.md, ...shadow.sm },
  sectionTitle: { ...typography.bodyMedium, color: colors.textPrimary, marginBottom: spacing.sm },
  itemsCard: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: spacing.md, gap: spacing.sm, ...shadow.sm },
