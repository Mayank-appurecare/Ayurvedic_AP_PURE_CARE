...
const FAQS = [
  {
    ...
    answer: 'Standard delivery takes 4-6 business days. Express and Same Day options are available at checkout for faster delivery.',
  },
  {
    question: 'What is your return policy?',
    answer: 'Unopened products can be returned within 7 days of delivery. Please contact support to initiate a return.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Each product page includes a "How to Use" section with recommended dosage and timing. Always follow the instructions on the label.',
  },
  {
    question: 'Can I cancel my order after placing it?',
    answer: 'Orders can be cancelled before they are shipped from the My Orders section. Once shipped, cancellation is not available.',
  },
  {
    question: 'Do you offer Cash on Delivery?',
    answer: 'Yes, Cash on Delivery is available for most pin codes alongside UPI, cards, net banking and wallets.',
  },
  {
...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  contactRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingVertical: spacing.sm + 2, paddingHorizontal: spacing.md },
  iconWrap: {
    width: 32,
    height: 32,
    borderRadius: 16,
